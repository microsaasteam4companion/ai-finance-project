...
export default function DashboardCharts({ transactions }: { transactions: any[] }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
      ...
      <div className="bg-card rounded-md p-4 md:p-6 border border-border shadow-sm">
      ...
      <div className="bg-card rounded-md p-4 md:p-6 border border-border shadow-sm flex flex-col">
