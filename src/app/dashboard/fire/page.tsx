...
import { Sparkles, Activity, Rocket, TrendingUp, Target, Calculator, Lock, CheckCircle2, ShieldCheck, ArrowDownRight } from 'lucide-react';
        ...
        {tier !== 'premium' && (
           <div className="absolute inset-x-0 top-0 z-50 rounded-3xl backdrop-blur-md bg-white/60 flex flex-col items-center justify-center border border-slate-200 mt-8 mb-20 shadow-xl overflow-hidden mx-8 h-[600px]">
              <div className="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center text-center max-w-md border border-slate-100">
                 ...
                 <button onClick={() => router.push('/dashboard/billing')} className="bg-orange-600 text-white px-8 py-3.5 rounded-xl font-bold hover:bg-orange-700 transition w-full shadow-lg shadow-orange-600/30">Unlock Premium ($25)</button>
              </div>
           </div>
        )}
