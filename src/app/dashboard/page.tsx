  ...
  return (
    <main className="flex-1 overflow-y-auto font-sans relative">
      ...
      <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 md:space-y-8 pb-20 relative">
        <div className="bg-gradient-to-r from-primary to-indigo-800 rounded-md p-8 md:p-12 text-white shadow-lg shadow-primary/20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10 group min-h-[220px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card rounded-md p-8 border border-border shadow-sm flex flex-col justify-between h-48 hover:shadow-md transition-shadow">
          ...
          <div className={`bg-card rounded-md p-8 border border-border shadow-sm flex flex-col justify-between h-48 relative overflow-hidden group hover:shadow-md transition-all cursor-pointer ${calculatingHealth ? 'opacity-70 scale-[0.99]' : ''}`} onClick={() => setShowWizard(true)}>
        ...
        <div className="bg-card border border-border rounded-md p-4 md:p-8 shadow-sm flex flex-col">
