...
import { LogOut, Home, PieChart, Sparkles, User as UserIcon, Activity, Rocket, UploadCloud, FileText, CheckCircle2, ShieldAlert, Loader2, IndianRupee, Lock, CreditCard, ArrowRight } from 'lucide-react';
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden text-slate-900">
      ...
      <main className="flex-1 overflow-y-auto w-full">
        <header className="bg-white border-b border-slate-200 px-8 py-5 flex items-center justify-between sticky top-0 z-20">
          <div>
             <h1 className="text-2xl font-bold tracking-tight text-slate-800 flex items-center gap-2">CA Tax Wizard</h1>
             <p className="text-sm text-slate-500 font-medium">India-focused regime comparison & 80C deductions.</p>
          </div>
